...
opts = optimoptions('ga',...
    ...
    'MutationFcn', {@mutationadaptfeasible, 0.1},... %algorithm selects a fraction of the vector entries of an individual for mutation, where each entry has a probability rate of being mutated
