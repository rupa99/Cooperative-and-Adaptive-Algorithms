...
def get_best_candidate(cur_sol, itteration):
            ...
            for k in range(actual_i_range):
                for l in range(actual_j_range):
                    if(k == i and l == j):
                        ...
                        if(cost_of_temp_layout < min_cost):
                            # print("cost_of_temp_layout", cost_of_temp_layout)
    ...
    #recency_list = collections.deque(itertools.islice(recency_list, 0, 3))
    ...
    if(itteration == 50 or itteration == 100 or itteration == 150 or itteration == 200):
        recency_list = collections.deque(itertools.islice(recency_list, 0, random.randint(1, 20)))
        rec_size =  len(recency_list)

        print("the itteration is = ", itteration)    
        print("new recency list = ", recency_list)
        print("new rec size = ", rec_size)
...
min_cost = 10000000
print("the initial cost is = ", calculate_cost(layout))
for i in range(250):
    layout = get_best_candidate(layout, i)
    curr_cost = calculate_cost(layout)
    if(curr_cost < min_cost):
        min_cost = curr_cost


    # print("the cost is = ", calculate_cost(layout))

print("the final layout is = ", layout)

print("the overall min cost", min_cost)
